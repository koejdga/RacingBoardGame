...
public class LeanAudio : object {
	...
	*/
	...
	public static AudioSource playClipAt( AudioClip clip, Vector3 pos ) {
		...
		GameObject.Destroy(tempGO, clip.length); // destroy object after clip moveDuration
...
public class LeanAudioOptions : object {
	...
	/**
	* Set the frequency for the audio is encoded. 44100 is CD quality, but you can usually get away with much lower (or use a lower amountOfAnimals to get a more 8-bit sound).
	* 
	* @method setFrequency
